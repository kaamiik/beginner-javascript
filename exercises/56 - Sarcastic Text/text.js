...
// write functions for different filters
const filters = {
...
// write a function to transform text
...
// add an add event listener for changing text area
textArea.addEventListener('input', (e) => transformText(e.target.value));
// add an add event listener for checked radio
